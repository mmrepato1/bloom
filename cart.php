...
require_once("{$_SERVER['DOCUMENT_ROOT']}/bloom/services/cart_service.php");
require_once("{$_SERVER['DOCUMENT_ROOT']}/bloom/services/order_service.php");
          ...
          <div class="card">
            <div class="card-body p-4">
              ...
              <div class="row">
                ...
                <div class="col-lg-7">
                  <h5 class="mb-3"><a href="/bloom/products.php" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Continue shopping</a></h5>
                  <hr>
                        ...
                        <div class="d-flex justify-content-between">
                          ...
                          <div class="d-flex flex-row align-items-center">
                            <div style="width: 50px;" class="mx-4">
                              <form action="/bloom/cart.php" method="POST">
                ...
                <div class="col-lg-5">
                  ...
                  <div class="card bg-primary text-white rounded-3">
                    <div class="card-body">
                      ...
                      <form class="mt-4" action="/bloom/cart.php" method="POST">
