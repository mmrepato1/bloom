...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['_action']) && $_POST['_action'] === 'delete_category') {
    ...
    try {
      delete_category($id);
      redirect("/bloom/admins/categories.php");
    } catch (Exception $e) {
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="/bloom/admins/categories.php" method="POST">
      ...
      <tbody>
        ...
        <?php foreach ($categories as $category) : ?>
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#edit_modal<?php echo ($category["id"]) ?>">
                <i class="fa-solid fa-pen-to-square"></i>
              </button>

              <!-- Modal -->
              <div class="modal fade" id="edit_modal<?php echo ($category["id"]) ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
              ...
              <form class="d-inline" action="/bloom/admins/categories.php" method="POST">
                <input type="hidden" name="id" value="<?php echo ($category["id"]) ?>">
