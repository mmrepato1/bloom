...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['_action']) && $_POST['_action'] === 'delete_product') {
    $id = $_POST['id'];
    try {
      delete_product($id);							//Call to function delete_product() 
      redirect("/bloom/admins/products.php");
    } catch (Exception $e) {
    ...
    if (in_array($product_image_actual_ext, $allowed)) {
      if ($product_image_error === 0) {
        if ($product_image_size < 1000000) {
          ...
          $product_image_destination = "{$_SERVER['DOCUMENT_ROOT']}/bloom/assets/images/products/" . $product_image_new_name;
          move_uploaded_file($product_image_tmp_name, $product_image_destination);
          $product_image_path = "/bloom/assets/images/products/" . $product_image_new_name;
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">				
			<form action="/bloom/admins/products.php" method="POST" enctype="multipart/form-data">
        ...
        <?php foreach ($products as $product) : ?>
          <tr>
            ...
            <td>
              ...
              <button type="button" class="btn btn-warning" data-mdb-toggle="modal" data-mdb-target="#edit_product_modal<?php echo ($product["id"]) ?>">
                <i class="fa-solid fa-pen-to-square"></i>
              </button>
			 
    <!-- Modal - UPDATE PRODUCTS-->

              <div class="modal fade" id="edit_product_modal<?php echo ($product["id"]) ?>" tabindex="-1" aria-labelledby="edit_product_modal_label" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="/bloom/admins/products.php" method="POST" enctype="multipart/form-data">
                       ...
                       <!-- <input type="hidden" name="id" value="<?php echo ($product["id"]) ?>"> -->
						 <input type="SHOW" name="id" value="<?php echo ($product["id"]) ?>"> 
              ...
              <form class="d-inline" action="/bloom/admins/products.php" method="POST">			  <!-- DELETE PRODUCT -->
                <input type="hide" name="id" value="<?php echo ($product["id"]) ?>">
