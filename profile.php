...
require_once("{$_SERVER['DOCUMENT_ROOT']}/bloom/utilities/user_utilities.php");
    ...
    if (in_array($profile_image_actual_ext, $allowed)) {
      if ($profile_image_error === 0) {
        if ($profile_image_size < 1000000) {
          ...
          $profile_image_destination = "{$_SERVER['DOCUMENT_ROOT']}/bloom/assets/images/profiles/" . $profile_image_newname;
          move_uploaded_file($profile_image_tmp_name, $profile_image_destination);
          $profile_image_path = "/bloom/assets/images/profiles/" . $profile_image_newname;
          update_profile($user["id"], $first_name, $last_name, $email, $profile_image_path);
          redirect("/bloom/profile.php");
        } else {
...
<body>
  ...
  <div class="container">
    ...
    <section class="update-profile shadow p-5 mb-5 bg-white rounded">
      ...
      <div class="row">
        ...
        <div class="col-md-8 ">
          ...
          <form method="POST" action="/bloom/profile.php" enctype="multipart/form-data">
    ...
    <section class="update-profile shadow p-5 mb-5 bg-white rounded">
      ...
      <div>
        <form method="POST" action="/bloom/profile.php">
          <div class="mb-3">
