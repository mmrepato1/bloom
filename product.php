...
<body>
  ...
  <div class="container">
    ...
    <a href="/bloom/products.php?category_id=<?php echo ($product["category_id"]) ?>" class="btn btn-primary" tabindex="-1" role="button" aria-disabled="true">Go Back</a>
    ...
    <div class="w-75 m-auto">
      ...
      <div class="body ">
        ...
        <div class="price d-flex align-items-center justify-content-between">
          ...
          <h2 class="mt-2">PHP <?php echo ($product["price"]) ?></h2>
